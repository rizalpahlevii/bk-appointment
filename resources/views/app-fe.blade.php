            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="{{route('login',['type'=>'admin'])}}">Admin</a></li>
                        <li><a class="dropdown-item" href="{{route('login',['type'=>'pasien'])}}">Pasien</a></li>
                        <li><a class="dropdown-item" href="{{route('login',['type'=>'dokter'])}}">Dokter</a></li>
